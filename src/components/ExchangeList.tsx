          ...
          <table className='exchangeList table'>
            <tbody>
              <tr key={0}>
                ...
                <th key={5} className='d-none d-lg-table-cell text-center'>
                  Incentive
                </th>
                <th key={6} className='d-none d-lg-table-cell text-center'>
                  Trust
                </th>
                <th key={7} className='d-none d-md-table-cell text-center'>
                  Trust rank
                </th>
                <th key={8} className='text-end'>
                  Vol 24h BTC
                </th>
              </tr>
