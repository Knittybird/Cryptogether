                  ...
                  <div className="metrics-title"> Key Metrics </div>
                    <div className="metrics-container">
                      <div className="h-high">
                        ...
                        <div className="value">$<SimpleNum value={coin.high_24h} /></div>
                      </div>
                      <div className="h-low">
                        <div className="title">24 HOUR LOW</div> 
                        <div className="value">$<SimpleNum value={coin.low_24h} /></div> 
                      </div>
                      <div className="net-change">
                        <div className="title">NET CHANGE</div>
                        <div className="value">${coin.price_change_24h}</div> 
                      </div>
                      <div className="ath">
                        <div className="title">ALL TIME HIGH</div>
                        <div className="value">$<SimpleNum value={coin.ath}/></div>
                      </div>
                      <div className="atl">
                        <div className="title">ALL TIME LOW</div>
                        <div className="value">$<SimpleNum value={coin.atl} /></div>
                      </div>
                      ...
                      <div className="supply">
                        ...
                        <div className="value">$<SimpleNum value={coin.circulating_supply} /></div>
                      </div>
